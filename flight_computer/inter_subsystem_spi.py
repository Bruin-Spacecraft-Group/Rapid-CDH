...
inter_subsystem_spi_bus = busio.SPI(board.SCK, MOSI=board.MOSI, MISO=board.MISO, slave_mode=False)

test_board_cs = digitalio.DigitalInOut(board.D2)
test_board_cs.direction = digitalio.Direction.OUTPUT
test_board = SPIDevice(inter_subsystem_spi_bus, test_board_cs) # baudrate, polarity, etc. available here as kw params
